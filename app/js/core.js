  ...
  const ce = [
    ...
    function (e) {
      ...
      function p() {
        ...
        if (
          ((t.params.navigation = J(t, t.originalParams.navigation, t.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), !e.nextEl && !e.prevEl)
        )
          return;
        let s = n(e.nextEl),
          a = n(e.prevEl);
...
$(function () {
  ...
  //Slider
  const lSlider = new Swiper(".slider-in", {
    slidesPerView: "auto",
    spaceBetween: 40,
    loop: true,
